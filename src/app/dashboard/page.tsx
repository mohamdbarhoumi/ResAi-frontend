...
import { API_URL } from "@/src/config/api";
  ...
  export default function Dashboard() {
    ...
    const handleDelete = async (resumeId: string) => {
      ...
      try {
        ...
        const response = await fetch(
          `${API_URL}/api/resumes/delete/${resumeId}`,
          {
            method: "DELETE",
            headers: { Authorization: `Bearer ${token}` },
          }
    ...
    return (
      <main className="min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-10 py-10">
        ...
        <section className="mt-20">
          ...
          {loading ? (
            ...
            >
              ...
              <div
                ...
                className="
                  w-full h-72 bg-white rounded-xl border-2 border-dashed 
                  border-gray-300 flex flex-col items-center justify-center 
                  cursor-pointer hover:shadow-xl hover:border-[#1E88E5] 
                  transition
                "
              >
                <span className="text-[#1E88E5] text-6xl sm:text-7xl leading-none font-semibold">
                  +
                </span>
              ...
              {resumes.map((resume) => (
                <div
                  key={resume.id}
                  className="
                    w-full h-72 bg-white shadow-md rounded-xl 
                  ...
                  <div className="p-4 border-t border-gray-200">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="
                          flex-1 bg-[#1E88E5] text-white py-2 px-4 rounded-lg 
                          text-sm font-medium hover:bg-[#1976D2] transition
                        "
                      >
                        Edit
                      </button>
                      <button
                        ...
                        className="
                          bg-red-50 text-red-600 py-2 px-4 rounded-lg 
          ...
          {!loading && resumes.length === 0 && (
            <div className="text-center py-20 text-gray-500">
              ...
              <p className="text-sm">
                Click the <span className="font-bold">+</span> card to create your first resume.
              </p>
            </div>
          )}
        </section>
